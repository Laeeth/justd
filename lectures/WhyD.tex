...
\begin{frame}[fragile]{Arrays Builtin \& Done Right}
  ...
  \item Easier Transition from C/C++ with:
    \begin{itemize}[<+->]
    \item C-Style Arrays Compatible \texttt{int a[2];}
    \item Easier Transition from C/C++: Clever Leading Principle: ``If it
      compiles it will behaviour will be equal to C''.
    \end{itemize}
