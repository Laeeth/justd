...
\author[Per Nordlöw, HiQ]{\textbf {Per Nordlöw\\HiQ}} % auteur
...
\begin{frame}[fragile]{Compilation Performance Facts}
  ...
  \item Multi-threading Unittesting (dtest) to get additional speedups.
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{CTFE Magic: Pegged}
\footnotesize
\begin{lstlisting}[frame=single]
import pegged.peg;
